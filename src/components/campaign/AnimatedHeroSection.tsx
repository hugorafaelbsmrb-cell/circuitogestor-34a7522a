      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        {urgencyText && (
          ...
          >
            <Badge 
              variant="destructive" 
              className="mb-6 px-4 py-2 text-sm font-semibold animate-pulse"
            >
        ...
        {/* Subtitle */}
        <motion.p 
          className="text-lg md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Button 
            size="lg" 
            onClick={onCtaClick}
            className="group bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-primary-foreground text-lg md:text-xl px-10 py-7 font-bold shadow-2xl hover:shadow-primary/25 transition-all duration-300 hover:scale-105 rounded-full"
          >
