...
import { Clock, CheckCircle2, Sparkles, Gift, Shield } from 'lucide-react';
              ...
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-6 sm:p-8 md:p-10 bg-card flex flex-col justify-center items-center text-center border-t md:border-t-0 md:border-l border-border">
                  ...
                  <div className="my-4 sm:my-6">
                    <p className="text-xs sm:text-sm text-muted-foreground mb-1">A partir de</p>
                    <div className="flex items-baseline justify-center gap-1">
                      <span className="text-base sm:text-lg text-muted-foreground">R$</span>
                      <span className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-primary">
                        {price.toFixed(0).replace('.', ',')}
                      </span>
                      <span className="text-base sm:text-lg text-muted-foreground">,{(price % 1).toFixed(2).split('.')[1]}</span>
                    </div>
                    <p className="text-xs sm:text-sm text-muted-foreground mt-1">/mês</p>
                  </div>
